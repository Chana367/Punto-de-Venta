        ...
        if (empty($id)) {
            ...
            if (empty($clave)) {
                ...
                if ($result) {
                    ...
                    $query_insert = $conexion->prepare("INSERT INTO usuario (nombre, correo, usuario, clave) VALUES (:nombre, :correo, :usuario, :clave)");
                    $query_insert->bindParam(':nombre', $nombre, PDO::PARAM_STR);
                    $query_insert->bindParam(':correo', $email, PDO::PARAM_STR);
                    $query_insert->bindParam(':usuario', $user, PDO::PARAM_STR);
                    $query_insert->bindParam(':clave', $clave, PDO::PARAM_STR);
            ...
            $sql_update = $conexion->prepare("UPDATE usuario SET nombre = :nombre, correo = :correo, usuario = :usuario WHERE idusuario = :id");
            $sql_update->bindParam(':nombre', $nombre, PDO::PARAM_STR);
            $sql_update->bindParam(':correo', $email, PDO::PARAM_STR);
            $sql_update->bindParam(':usuario', $user, PDO::PARAM_STR);
